...
class Products {
  ...
  DateTime? expiryDate; // Make expiryDate nullable
  ...
  Products({
    ...
    this.expiryDate, // expiryDate is now nullable
  ...
  factory Products.fromJson(Map<String, dynamic> json) {
    return Products(
      ...
      expiryDate: json['expiryDate'] != null
          ...
          : null, // Check if expiryDate is null
      reviews: [],
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'expiryDate': expiryDate?.toIso8601String(), // Use nullable operator
