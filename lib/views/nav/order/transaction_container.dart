  ...
  void _cancelOrder() {
    ...
    context
        ...
        .cancelTrancsaction(
          ...
          "Order cancelled due to non-payment within the time limit",
        )
        .then((_) {
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            if (widget.transactions.status == TransactionStatus.CANCELLED)
              Container(
                width: double.infinity,
                ...
                widget.transactions.payment.status == PaymentStatus.UNPAID &&
                widget.transactions.payment.type == PaymentType.GCASH)
              Container(
                width: double.infinity,
                color: Colors.red.withOpacity(0.1),
